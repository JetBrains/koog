...
/**
 * A file-based [VectorStore] implementation for text documents.
 *
 ...
 */
public open class TextFileDocumentEmbeddingStore<Document, Path>(
    embedder: Embedder,
    documentProvider: DocumentProvider<Path, Document>,
    fs: FileSystemProvider.ReadWrite<Path>,
    root: Path
) : FileDocumentEmbeddingStore<Document, Path>(
