...
dependencies {
    ...
    api(project(":agents:agents-features:agents-features-pool"))
...
registerRunExampleTask("runAgentPoolBenchmark", "ai.koog.agents.example.pool.JvmAgentPoolBenchmarkExampleKt")
