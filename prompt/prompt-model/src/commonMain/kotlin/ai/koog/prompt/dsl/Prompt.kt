...
public data class Prompt @JvmOverloads constructor(
    ...
    public companion object {
         ...
         * @param clock The clock used for timestamping or time-related operations. Defaults to [AgentClock.System] if not provided.
         * @return A new instance of `PromptBuilder` with the specified ID and clock.
         */
        @JvmStatic
        @JvmOverloads
        @JavaAPI
        public fun builder(id: String, clock: AgentClock = AgentClock.System): PromptBuilder = PromptBuilder(id, clock = clock)
         ...
         * @param clock The clock to use for generating timestamps, defaults to [AgentClock.System].
         ...
         */
        public fun build(prompt: Prompt, clock: AgentClock = AgentClock.System, init: PromptBuilder.() -> Unit): Prompt {
