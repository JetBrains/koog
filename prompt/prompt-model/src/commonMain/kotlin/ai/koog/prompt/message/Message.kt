...
public sealed interface Message {
     ...
     *
     */
    public fun User(content: String, metaInfo: RequestMetaInfo): User = User(Content.Text(content), metaInfo)

    /**
     * Represents a message sent by the user as a request.
     *
     * @property content The content of the user's message.
     ...
     *
     */
    public fun Assistant(content: String, metaInfo: ResponseMetaInfo, finishReason: String? = null): Assistant =
        Assistant(Content.Text(content), metaInfo, finishReason)

    /**
     * Represents a message generated by the assistant as a response.
     *
     * @property content The content of the assistant's response.
    ...
    public sealed interface Tool : Message {
        ...
        public data class Call(
            ...
            init {
                require(content is Content.Text) {
                    "The content of a tool call must be text not parts"
                }
            }
        ...
        public data class Result(
            ...
            init {
                require(content is Content.Text) {
                    "The content of a tool return must be text not parts"
                }
            }
     ...
     *
     */
    public fun System(content: String, metaInfo: RequestMetaInfo): System = System(Content.Text(content), metaInfo)
    ...
    public data class System(
        ...
        init {
            require(content is Content.Text) {
                "The content of a system message must be text not parts"
            }
        }
    }
}
