...
public interface PromptExecutorAPI : AutoCloseable {
    ...
    public suspend fun execute(
        ...
        tools: List<ToolDescriptor> = emptyList()
    ): List<Message.Response> = throw MODEL_SELECTION_NOT_SUPPORTED
    ...
    public fun executeStreaming(
        ...
        modelSelector: ModelSelector,
        tools: List<ToolDescriptor> = emptyList()
    ): Flow<StreamFrame> = throw MODEL_SELECTION_NOT_SUPPORTED
    ...
    public suspend fun executeMultipleChoices(
        ...
        modelSelector: ModelSelector,
        tools: List<ToolDescriptor> = emptyList()
    ): List<LLMChoice> = listOf(execute(prompt, modelSelector, tools))
    ...
    public suspend fun moderate(prompt: Prompt, modelSelector: ModelSelector): ModerationResult =
        throw MODEL_SELECTION_NOT_SUPPORTED
...
private val MODEL_SELECTION_NOT_SUPPORTED = UnsupportedOperationException(
    "Model selection is not supported by this executor"
)
