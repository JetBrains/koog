...
public interface PromptExecutor {
     ...
     *
     * @param prompt The prompt to execute, containing the input messages, id, and execution parameters.
     * @param model The language model to use for executing the prompt.
     * @return The textual response content from the executed prompt.
     */
