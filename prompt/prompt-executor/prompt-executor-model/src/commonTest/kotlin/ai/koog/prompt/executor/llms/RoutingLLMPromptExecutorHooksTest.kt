...
/**
 * Test class for verifying the hook lifecycle of [RoutingLLMPromptExecutor].
...
class RoutingLLMPromptExecutorHooksTest : PromptExecutorHooksTestBase() {
    ...
    override fun createExecutor(client: LLMClient): HookablePromptExecutor = RoutingLLMPromptExecutor(client)
}
