...
class OpenAISuspendableDirectClientTest {
    ...
    fun testCreateClient() {
        // TODO: pass the `OPEN_AI_API_TEST_KEY`
        return
    ...
    @Disabled("This test requires a valid OpenAI API key")
    @Test
    fun testExecuteStreamingPrompt_O3Mini() = runTest {
        // TODO: pass the `OPEN_AI_API_TEST_KEY`
        return@runTest
    ...
    @Disabled("This test requires a valid OpenAI API key")
    @Test
    fun testExecuteWithTools_GPT4oMini() = runTest {
        // TODO: pass the `OPEN_AI_API_TEST_KEY`
        return@runTest
    ...
    @Disabled("This test requires a valid OpenAI API key")
    @Test
    fun testCodeGeneration_GPT4oMini() = runTest {
        // TODO: pass the `OPEN_AI_API_TEST_KEY`
        return@runTest
