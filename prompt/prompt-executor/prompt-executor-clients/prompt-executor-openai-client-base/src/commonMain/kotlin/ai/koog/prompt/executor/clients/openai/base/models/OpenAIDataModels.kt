...
public sealed interface OpenAIMessage {
     ...
     * @property reasoningContent Chain-of-thought reasoning content from DeepSeek Reasoner and similar models.
     * @property toolCalls The tool calls generated by the model, such as function calls.
     * @property annotations The list of URL citations when using web search.
     */
    @Serializable
...
public sealed interface OpenAIContentPart {
     ...
     * Used to pass file data to OpenAI APIs requiring file handling.
     *
 ...
 * [ash][OpenAIAudioVoice.Ash], [ballad][OpenAIAudioVoice.Ballad],
 ...
 *   even during peak demand; available on a flexible, pay-as-you-use basis
...
public enum class ServiceTier {
     ...
     * during peak demand; available pay-as-you-use without pre-provisioning.
 ...
 * @property promptTokensDetails Breakdown of tokens used in a prompt.
 *
