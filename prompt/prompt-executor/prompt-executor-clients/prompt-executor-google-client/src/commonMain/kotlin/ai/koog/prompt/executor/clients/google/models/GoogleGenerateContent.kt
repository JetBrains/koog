 ...
 * @property cachedContentTokenCount Number of tokens in the prompt that were served from an implicit
 * or explicit cache, so were not billed or computed at the full prompt rate.
 */
@Serializable
