...
import ai.koog.prompt.executor.clients.ollama.dto.EmbeddingRequestDTO
import ai.koog.prompt.executor.clients.ollama.dto.EmbeddingResponseDTO
import ai.koog.prompt.executor.clients.ollama.dto.OllamaChatRequestDTO
import ai.koog.prompt.executor.clients.ollama.dto.OllamaChatResponseDTO
import ai.koog.prompt.executor.clients.ollama.dto.OllamaErrorResponseDTO
import ai.koog.prompt.executor.clients.ollama.dto.OllamaModelsListResponseDTO
import ai.koog.prompt.executor.clients.ollama.dto.OllamaPullModelRequestDTO
import ai.koog.prompt.executor.clients.ollama.dto.OllamaPullModelResponseDTO
import ai.koog.prompt.executor.clients.ollama.dto.OllamaShowModelRequestDTO
import ai.koog.prompt.executor.clients.ollama.dto.OllamaShowModelResponseDTO
import ai.koog.prompt.executor.clients.ollama.dto.extractOllamaJsonFormat
import ai.koog.prompt.executor.clients.ollama.dto.extractOllamaOptions
import ai.koog.prompt.executor.clients.ollama.dto.getToolCalls
import ai.koog.prompt.executor.clients.ollama.dto.toOllamaChatMessages
import ai.koog.prompt.executor.clients.ollama.dto.toOllamaModelCard
import ai.koog.prompt.executor.clients.ollama.dto.toOllamaTool
