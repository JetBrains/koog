...
import ai.koog.prompt.executor.clients.siliconflow.models.ProviderPreferences
import ai.koog.prompt.params.LLMParams
import kotlinx.serialization.json.JsonElement

internal fun LLMParams.toSiliconFlowParams(): SiliconFlowParams {
    if (this is SiliconFlowParams) return this
    return SiliconFlowParams(
...
/**
 * SiliconFlow chat-completions parameters layered on top of [LLMParams].
 *
 ...
 */
public open class SiliconFlowParams(
    ...
    ): SiliconFlowParams = SiliconFlowParams(
        temperature = temperature,
        maxTokens = maxTokens,
        numberOfChoices = numberOfChoices,
        speculation = speculation,
    ...
    override fun equals(other: Any?): Boolean = when {
        this === other -> true
        other !is SiliconFlowParams -> false
        else ->
