...
/**
 * SiliconFlow Chat Completions API Request
 * https://docs.siliconflow.cn/cn/api-reference/
 */
@Serializable
internal class SiliconFlowChatCompletionRequest(
 ...
 *
 * See (CompletionsResponse Format)[https://docs.siliconflow.cn/cn/api-reference/chat-completions/chat-completions]
 */
@Serializable
public class SiliconFlowChoice(
 ...
 * @property error An error response structure typically used for conveying error details to the clients.
 *
 * See (CompletionsResponse Format)[https://docs.siliconflow.cn/cn/api-reference/chat-completions/chat-completions#body-one-of-0-thinking-budget]
 */
@Serializable
public class SiliconFlowStreamChoice(
    public val finishReason: String? = null,
    public val nativeFinishReason: String? = null,
    public val delta: SiliconFlowStreamDelta,
    public val error: ErrorResponse? = null
)
 ...
 */
@Serializable
public class SiliconFlowStreamDelta(
...
/**
 * SiliconFlow Chat Completion Response
 * See (CompletionsResponse Format)[https://docs.siliconflow.cn/cn/api-reference/chat-completions/chat-completions#body-one-of-0-thinking-budget]
 */
@Serializable
public class SiliconFlowChatCompletionResponse(
    public val choices: List<SiliconFlowChoice> = emptyList(),
    ...
    public val error: SiliconFlowError? = null,
) : OpenAIBaseLLMResponse

/**
 * SiliconFlow Chat Completion Streaming Response
 * See (CompletionsResponse Format)[https://docs.siliconflow.cn/cn/api-reference/chat-completions/chat-completions#body-one-of-0-thinking-budget]
 */
@Serializable
public class SiliconFlowChatCompletionStreamResponse(
    public val choices: List<SiliconFlowStreamChoice>,
...
/**
 * SiliconFlow API Error Response
 */
@Serializable
public class SiliconFlowError(
    public val message: String,
    public val type: String? = null,
    public val code: String? = null,
)

internal object SiliconFlowChatCompletionRequestSerializer :
    AdditionalPropertiesFlatteningSerializer<SiliconFlowChatCompletionRequest>(SiliconFlowChatCompletionRequest.serializer())
