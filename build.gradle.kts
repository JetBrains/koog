...
dependencies {
    ...
    dokka(project(":koog-spring-ai-2:koog-spring-ai-2-starter-chat-memory"))
    dokka(project(":koog-spring-ai-2:koog-spring-ai-2-starter-model-chat"))
    dokka(project(":koog-spring-ai-2:koog-spring-ai-2-starter-model-embedding"))
    dokka(project(":koog-spring-ai-2:koog-spring-ai-2-starter-vector-store"))
