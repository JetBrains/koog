...
import ai.koog.prompt.executor.llms.all.getModelFromIdentifier as getModelFromIdentifierImpl
 ...
 */
@Deprecated(
    message = "Moved to ai.koog.prompt.executor.llms.all package",
    replaceWith = ReplaceWith(
        "getModelFromIdentifier(identifier, delimiter)",
        "ai.koog.prompt.executor.llms.all.getModelFromIdentifier"
    )
)
