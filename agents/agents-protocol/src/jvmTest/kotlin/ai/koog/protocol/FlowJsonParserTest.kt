...
class FlowJsonParserTest : FlowTestBase() {
    ...
    companion object {
        ...
        fun getResourceJsonNames(): Array<String> {
            val resourceJsonPath = object {}.javaClass.getResource("/json")?.toURI()?.toPath()
    ...
    fun testJsonParsing_verifyTransformFlowJson() {
        ...
        assertEquals("output.success", transition2.condition.variable)
        ...
        assertEquals("output.success", transition3.condition.variable)
