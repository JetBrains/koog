...
class AgentcoreMessageConverterTest {
    ...
    fun testConversationalUserToMessage() {
        ...
        val message = AgentcoreMessageConverter.conversationalToMessage(conversational, randomEventId, AgentClock.System.now())
    ...
    fun testConversationalToolRoleReturnsNullWhenIgnored() {
        ...
        assertNull(AgentcoreMessageConverter.conversationalToMessage(conversational, randomEventId, AgentClock.System.now(), ignoreUnsupportedValues = true))
    }
    ...
    fun testConversationalToolRoleThrowsWhenNotIgnored() {
        ...
        assertFailsWith<IllegalStateException> {
            AgentcoreMessageConverter.conversationalToMessage(conversational, randomEventId, AgentClock.System.now(), ignoreUnsupportedValues = false)
        }
    }
    ...
    fun testConversationalOtherRoleReturnsNull() {
        ...
        assertNull(AgentcoreMessageConverter.conversationalToMessage(conversational, randomEventId, AgentClock.System.now()))
    }
    ...
    fun testConversationalToMessageWithEventId() {
        ...
        val message = AgentcoreMessageConverter.conversationalToMessage(conversational, eventId = "evt-123", AgentClock.System.now())
    ...
    fun testUserMessageRoundTrip() {
        ...
        val restored = AgentcoreMessageConverter.conversationalToMessage(payload.value, randomEventId, AgentClock.System.now())
    ...
    fun testMixedMessagesRoundTrip() {
        ...
        val restored = payloads.mapNotNull { AgentcoreMessageConverter.conversationalToMessage(it.value, randomEventId, AgentClock.System.now()) }
