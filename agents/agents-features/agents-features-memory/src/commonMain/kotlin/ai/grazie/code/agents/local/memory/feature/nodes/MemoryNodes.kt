 ...
 */
fun <T> AgentSubgraphBuilderBase<*, *>.nodeLoadFromMemory(
    name: String? = null,
    concept: Concept,
    subject: MemorySubject,
    scope: MemoryScopeType = MemoryScopeType.AGENT
): AgentNodeDelegate<T, T> = nodeLoadFromMemory(name, listOf(concept), listOf(subject), listOf(scope))
...
fun <T> AgentSubgraphBuilderBase<*, *>.nodeLoadFromMemory(
    ...
    subject: MemorySubject,
    scope: MemoryScopeType = MemoryScopeType.AGENT
): AgentNodeDelegate<T, T> = nodeLoadFromMemory(name, concepts, listOf(subject), listOf(scope))
 ...
 */
fun <T> AgentSubgraphBuilderBase<*, *>.nodeLoadAllFactsFromMemory(
    name: String? = null,
    subjects: List<MemorySubject> = MemorySubject.entries,
    scopes: List<MemoryScopeType> = MemoryScopeType.entries
): AgentNodeDelegate<T, T> = node(name) { input ->
 ...
 */
fun <T> AgentSubgraphBuilderBase<*, *>.nodeSaveToMemory(
    name: String? = null,
    subject: MemorySubject,
...
fun <T> AgentSubgraphBuilderBase<*, *>.nodeSaveToMemory(
    ...
    subject: MemorySubject,
    scope: MemoryScopeType,
): AgentNodeDelegate<T, T> = nodeSaveToMemory(name, subject, scope, listOf(concept))
 ...
 */
fun <T> AgentSubgraphBuilderBase<*, *>.nodeSaveToMemoryAutoDetectFacts(
    name: String? = null,
