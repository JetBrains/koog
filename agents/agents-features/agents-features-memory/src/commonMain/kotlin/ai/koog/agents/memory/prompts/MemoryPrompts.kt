...
internal object MemoryPrompts {
    internal fun singleFactPrompt(concept: Concept) =
        "Based on our conversation, what is the most important fact about concept \"${concept.keyword}\" (${concept.description}) ? " +
    ...
    internal fun multipleFactsPrompt(concept: Concept) =
        "Based on our conversation, what are the key facts about concept \"${concept.keyword}\" (${concept.description}) ? " +
