package ai.grazie.code.agents.features.eventHandler.feature
...
class EventHandler {
    /**
     * Implementation of the [AIAgentFeatureBase] interface for the [EventHandler] feature.
     * 
     ...
     * }
     */
    companion object Feature : AIAgentFeatureBase<EventHandlerConfig, EventHandler> {

        private val logger: MPPLogger =
            LoggerFactory.create("ai.grazie.code.agents.features.eventHandler.feature.EventHandler")
