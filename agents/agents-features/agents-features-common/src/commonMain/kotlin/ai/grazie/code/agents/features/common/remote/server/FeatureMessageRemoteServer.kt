package ai.grazie.code.agents.features.common.remote.server

import ai.grazie.code.agents.features.common.ExceptionExtractor.rootCause
...
class FeatureMessageRemoteServer(
    ...
    companion object {
        private val logger: MPPLogger =
            LoggerFactory.create("ai.grazie.code.agents.features.tracing.server.KtorTracingServer")
    }
