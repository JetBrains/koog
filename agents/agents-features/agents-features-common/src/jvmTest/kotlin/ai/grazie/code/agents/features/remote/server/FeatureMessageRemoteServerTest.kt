package ai.grazie.code.agents.features.remote.server

import ai.grazie.code.agents.features.NetUtil.findAvailablePort
import ai.grazie.code.agents.features.common.message.FeatureMessage
import ai.grazie.code.agents.features.common.message.FeatureStringMessage
import ai.grazie.code.agents.features.common.message.use
import ai.grazie.code.agents.features.common.remote.client.FeatureMessageRemoteClient
import ai.grazie.code.agents.features.common.remote.client.config.DefaultClientConnectionConfig
import ai.grazie.code.agents.features.common.remote.server.FeatureMessageRemoteServer
import ai.grazie.code.agents.features.common.remote.server.config.DefaultServerConnectionConfig
import ai.grazie.code.agents.features.writer.TestFeatureEventMessage
...
class FeatureMessageRemoteServerTest {
    ...
    companion object {
        private val logger: MPPLogger =
            LoggerFactory.create("ai.grazie.code.agents.features.remote.server.FeatureMessageRemoteServerTest")
