package ai.koog.agents.local.features.remote.server

import ai.koog.agents.local.features.NetUtil.findAvailablePort
...
import ai.koog.agents.local.features.common.remote.client.config.DefaultClientConnectionConfig
import ai.koog.agents.local.features.common.remote.server.FeatureMessageRemoteServer
...
class FeatureMessageRemoteServerTest {
    ...
    companion object {
        private val logger: MPPLogger =
            LoggerFactory.create("ai.koog.agents.local.features.remote.server.FeatureMessageRemoteServerTest")
