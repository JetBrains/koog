...
/**
 * Validates a given condition and throws a [ValidationFailure] exception if the condition is not met.
 *
 ...
 * a [ValidationFailure] exception is thrown with the provided error message.
 *
...
/**
 * Throws a [ValidationFailure] exception with the specified error message.
 *
