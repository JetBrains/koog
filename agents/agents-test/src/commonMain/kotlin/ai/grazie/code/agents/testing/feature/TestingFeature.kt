...
class DummyAgentStageContext(
    ...
    override fun <Feature : Any> feature(feature: AIAgentFeatureBase<*, Feature>): Feature? =
        throw NotImplementedError("feature()  getting in runtime is not supported for mock")
...
@TestOnly
interface LocalAgentStageContextMockBuilderBase : BaseBuilder<AIAgentStageContextBase> {
...
class Testing {
     ...
     */
    @TestOnly
    companion object Feature : AIAgentFeatureBase<Config, Testing> {
        /**
