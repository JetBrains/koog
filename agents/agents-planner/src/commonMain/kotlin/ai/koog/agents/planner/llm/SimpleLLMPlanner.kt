...
) : AIAgentPlanner<String, String, String, SimplePlan>(
    stateType = typeToken<String>(),
    planType = typeToken<SimplePlan>(),
) {
    override fun initializeState(input: String): String = input
    override fun provideOutput(state: String): String = state
