 ...
 * @property timestamp The timestamp of the event, in milliseconds since the Unix epoch.
 * @property duration Elapsed time of the node's body execution. See `NodeExecutionCompletedContext.duration`
 * for full semantics.
 */
@Serializable
public data class NodeExecutionCompletedEvent(
    ...
    @Deprecated(
        ...
        replaceWith = ReplaceWith("NodeExecutionCompletedEvent(executionInfo, runId, nodeName, input, output, duration, timestamp)")
    )
    public constructor(
        runId: String,
        nodeName: String,
 ...
 * @property timestamp The timestamp of the event, in milliseconds since the Unix epoch.
 * @property duration Elapsed time of the node's body execution up to the failure. See
 * `NodeExecutionFailedContext.duration` for full semantics.
 */
@Serializable
public data class NodeExecutionFailedEvent(
    ...
    @Deprecated(
        message = "Use constructor with executionInfo parameter, and input parameter of type [JSONElement]",
        replaceWith = ReplaceWith("NodeExecutionFailedEvent(executionInfo, runId, nodeName, input, error, duration, timestamp)")
    )
    public constructor(
        runId: String,
        nodeName: String,
