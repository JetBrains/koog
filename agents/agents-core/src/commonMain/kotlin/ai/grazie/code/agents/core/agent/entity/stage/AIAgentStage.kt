...
sealed class AIAgentStage(name: String, start: StartAIAgentNode) : AIAgentSubgraph<Unit, String>(
    name, start, FinishAIAgentNode(), ToolSelectionStrategy.ALL
) {
    suspend fun execute(context: AIAgentStageContextBase): String = execute(context, Unit)
}
...
class AIAgentStaticStage internal constructor(
    name: String,
    startNode: StartAIAgentNode,
 ...
 */
class AIAgentDynamicStage internal constructor(
    name: String,
    startNode: StartAIAgentNode,
) : AIAgentStage(name, startNode) {
    override suspend fun execute(context: AIAgentStageContextBase, input: Unit): String {
