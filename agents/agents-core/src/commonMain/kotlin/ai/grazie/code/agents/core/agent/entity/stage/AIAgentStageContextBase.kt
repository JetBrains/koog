 ...
 */
interface AIAgentStageContextBase {
    /**
    ...
    fun <Feature : Any> feature(key: AIAgentStorageKey<Feature>): Feature?

    /**
     * Retrieves a feature of the specified type from the current context.
     *
     * @param feature The [AIAgentFeatureBase] instance representing the feature to retrieve.
     ...
     */
    fun <Feature : Any> feature(feature: AIAgentFeatureBase<*, Feature>): Feature?
     ...
     */
    @InternalAgentsApi
    fun copyWithTools(tools: List<ToolDescriptor>): AIAgentStageContextBase {
 ...
 */
class AIAgentStageContext constructor(
     ...
     */
    override fun <Feature : Any> feature(feature: AIAgentFeatureBase<*, Feature>): Feature? = feature(feature.key)
...
data class AIAgentLLMContext(
    ...
    suspend fun <T> writeSession(block: suspend AIAgentLLMWriteSession.() -> T): T = rwLock.withWriteLock {
 ...
 */
@Suppress("unused")
class AIAgentLLMWriteSession internal constructor(
    val environment: AIAgentEnvironment,
