 ...
 */
open class AIAgentException(problem: String, throwable: Throwable? = null) :
 ...
 */
class AIAgentStuckInTheNodeException(node: AIAgentNodeBase<*, *>, output: Any?) :
    AIAgentException(
 ...
 */
class AIAgentMaxNumberOfIterationsReachedException(maxNumberOfIterations: Int) :
    AIAgentException(
 ...
 */
class AIAgentTerminationByClientException(message: String) :
