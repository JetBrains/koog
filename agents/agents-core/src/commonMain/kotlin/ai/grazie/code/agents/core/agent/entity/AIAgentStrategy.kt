...
import ai.grazie.code.agents.core.model.agent.AIAgentStrategyBase
...
class AIAgentStrategy(
...
) : AIAgentStrategyBase<AIAgentConfig>, AIAgentNodeBase<String, String>() {
     ...
     * as a node within another agent's stage. It wraps the provided environment in a [SubAIAgentEnvironment]
    ...
    override suspend fun execute(context: AIAgentStageContextBase, input: String): String {
        val wrappedEnv = SubAIAgentEnvironment(context.environment)
