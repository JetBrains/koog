...
class AIAgentPipeline {
    ...
    suspend fun onAgentCreated(strategy: AIAgentStrategy, agent: AIAgent) {
     ...
     */
    fun getStageFeatures(context: AIAgentStageContextBase): Map<AIAgentStorageKey<*>, Any> {
     ...
     */
    suspend fun onBeforeNode(node: AIAgentNodeBase<*, *>, context: AIAgentStageContextBase, input: Any?) {
     ...
     */
    suspend fun onAfterNode(node: AIAgentNodeBase<*, *>, context: AIAgentStageContextBase, input: Any?, output: Any?) {
    ...
    fun <TFeature : Any> interceptContextStageFeature(
        feature: AIAgentFeatureBase<*, TFeature>,
