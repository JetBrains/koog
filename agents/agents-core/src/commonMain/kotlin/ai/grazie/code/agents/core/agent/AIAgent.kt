...
open class AIAgent(
     ...
     */
    class FeatureContext internal constructor(val agent: AIAgent) {
        suspend fun <Config : FeatureConfig, Feature : Any> install(
            feature: AIAgentFeatureBase<Config, Feature>,
    ...
    override suspend fun executeTools(toolCalls: List<Message.Tool.Call>): List<ReceivedToolResult> {
        ...
        val message = AIAgentToolCallsToEnvironmentMessage(
            sessionUuid = sessionUuid ?: throw IllegalStateException("Session UUID is null"),
            content = toolCalls.map { call ->
                AIAgentToolCallToEnvironmentContent(
    ...
    override suspend fun sendTermination(result: String?) {
        ...
        val message = AIAgentTerminationToEnvironmentMessage(
            sessionUuid ?: throw IllegalStateException("Session UUID is null"),
            content = AIAgentToolCallToEnvironmentContent(
                agentId = strategy.name,
                toolCallId = null,
    ...
    @OptIn(InternalAgentToolsApi::class)
    private suspend fun processToolCall(content: AIAgentToolCallToEnvironmentContent): AIEnvironmentToolResultToAgentContent =
        allowToolCalls {
    ...
    private suspend fun processToolCallMultiple(message: AIAgentToolCallsToEnvironmentMessage): AIEnvironmentToolResultMultipleToAgentMessage {
        ...
        return AIEnvironmentToolResultMultipleToAgentMessage(
    ...
    private fun toolResult(
        ...
        message: String,
        result: ToolResult?
    ): AIEnvironmentToolResultToAgentContent = AIAgentEnvironmentToolResultToAgentMessageContent(
    ...
    private suspend fun terminate(message: AIAgentTerminationToEnvironmentMessage) {
