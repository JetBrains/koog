...
-   :material-database-search:{ .lg .middle } [**Knowledge retrieval**](embeddings.md)
    ...
    Retain and retrieve knowledge across conversations using [vector embeddings](embeddings.md), [RAG](retrieval-augmented-generation.md), and [shared agent memory](agent-memory.md)
