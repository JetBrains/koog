...
| Requesty       | [simpleRequestyExecutor](api:prompt-executor-llms-all::ai.koog.prompt.executor.llms.all.simpleRequestyExecutor)                               | Wraps `RequestyLLMClient` that runs prompts with Requesty.                       |
