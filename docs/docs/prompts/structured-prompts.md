...
The structured prompts let you pre-configure conversation history with multiple messages, provide mulimodal content, examples, tool calls and their results.
...
This type of messages is used to pre-populate the tool interaction history.
