...
| Apple Foundation Models (iOS 26+, beta)                                                                                                                     | On-device inference on Apple hardware with no network dependency; requires Apple Intelligence and an eligible device.            |
...
| <div style="width:115px">LLM capability</div> | OpenAI                       | Anthropic                 | Google                                  | DeepSeek | OpenRouter       | Amazon Bedrock   | Mistral                   | Alibaba (DashScope OpenAI-compatible client) | Ollama (local models) | Apple Foundation Models (iOS 26+, beta) |
|-----------------------------------------------|------------------------------|---------------------------|-----------------------------------------|----------|------------------|------------------|---------------------------|----------------------------------------------|-----------------------|-----------------------------------------|
| Supported input                               | Text, image, audio, document | Text, image, document[^1] | Text, image, audio, video, document[^1] | Text     | Differs by model | Differs by model | Text, image, document[^1] | Text, image, audio, video[^1]                | Text, image[^1]       | Text                                    |
| Response streaming                            | ✓                            | ✓                         | ✓                                       | ✓        | ✓                | ✓                | ✓                         | ✓                                            | ✓                     | –                                       |
| Tools                                         | ✓                            | ✓                         | ✓                                       | ✓        | ✓                | ✓[^1]            | ✓                         | ✓                                            | ✓                     | –                                       |
| Tool choice                                   | ✓                            | ✓                         | ✓                                       | ✓        | ✓                | ✓[^1]            | ✓                         | ✓                                            | –                     | –                                       |
